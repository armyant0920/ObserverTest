...
public class Clown extends Observable {
    ...
    /** 表演完毕 */
    public static final int PERFORM_COMPLETE = 999;

    public static int performScore=0;

//    public static final String PERFORM_COMPLETE="leave";
    /**
     * 表演
     */
    public void perform() {
        ...
        System.out.println("**小丑這次表演的分數是"+random);
        performScore=random;
